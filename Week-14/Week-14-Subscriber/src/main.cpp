...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.58.177"; // Change to your MQTT broker IP
const int mqtt_port = 1883;

const char* TOPIC_TEMP = "home/Iot-Lab14/temp"; // Topic for temperature
