...
// ---------- MQTT ----------
const char* mqtt_server = "10.13.57.83";  // Mosquitto / Cloud broker
const int   mqtt_port   = 1883;

// Topics
const char* TOPIC_TEMP = "home/AIlab1/temp";
const char* TOPIC_HUM  = "home/AIlab1/hum";
